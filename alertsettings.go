...
func newAlertSettings(rootSDK *Tirdad, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AlertSettings {
...
func (s *AlertSettings) CreateAlertSettings(ctx context.Context, request types.CreateAlertSettingsRequest, opts ...dtos.Option) (*dtos.CreateAlertSettingsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/alerts/setting")
	if err != nil {
	...
	res := &dtos.CreateAlertSettingsResponse{
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out types.AlertSettingsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AlertSettingsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AlertSettings) QueryAlertSettings(ctx context.Context, request types.AlertSettingsFilter, opts ...dtos.Option) (*dtos.QueryAlertSettingsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/alerts/setting/search")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &dtos.QueryAlertSettingsResponse{
		HTTPMeta: types.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out types.ListAlertSettingsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListAlertSettingsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *AlertSettings) GetAlertSettings(ctx context.Context, id string, opts ...dtos.Option) (*dtos.GetAlertSettingsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/alerts/setting/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &dtos.GetAlertSettingsResponse{
		HTTPMeta: types.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *AlertSettings) UpdateAlertSettings(ctx context.Context, id string, body types.UpdateAlertSettingsRequest, opts ...dtos.Option) (*dtos.UpdateAlertSettingsResponse, error) {
	...
	res := &dtos.UpdateAlertSettingsResponse{
		HTTPMeta: types.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *AlertSettings) DeleteAlertSettings(ctx context.Context, id string, opts ...dtos.Option) (*dtos.DeleteAlertSettingsResponse, error) {
	...
	res := &dtos.DeleteAlertSettingsResponse{
		HTTPMeta: types.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
