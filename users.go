...
func newUsers(rootSDK *Tirdad, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Users {
	return &Users{
		rootSDK:          rootSDK,
...
func (s *Users) UpdateServiceAccount(ctx context.Context, id string, body types.UpdateServiceAccountRequest, opts ...dtos.Option) (*dtos.UpdateServiceAccountResponse, error) {
	...
	res := &dtos.UpdateServiceAccountResponse{
		HTTPMeta: types.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out types.UpdateServiceAccountResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UpdateServiceAccountResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Users) DeleteServiceAccount(ctx context.Context, id string, opts ...dtos.Option) (*dtos.DeleteServiceAccountResponse, error) {
	...
	res := &dtos.DeleteServiceAccountResponse{
		HTTPMeta: types.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Users) RemoveUser(ctx context.Context, id string, opts ...dtos.Option) (*dtos.RemoveUserResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/users/{id}/remove", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Users) UpdateUserRoles(ctx context.Context, id string, body types.UpdateUserRolesRequest, opts ...dtos.Option) (*dtos.UpdateUserRolesResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/users/{id}/roles", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &dtos.UpdateUserRolesResponse{
		HTTPMeta: types.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out types.UpdateUserRolesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UpdateUserRolesResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
