...
const (
	...
	WebhookEventNameSubscriptionPlanChanged                     WebhookEventName = "subscription.plan_changed"
	...
	WebhookEventNameRefundCreated                               WebhookEventName = "refund.created"
	WebhookEventNameRefundSucceeded                             WebhookEventName = "refund.succeeded"
	WebhookEventNameRefundFailed                                WebhookEventName = "refund.failed"
	...
	WebhookEventNameCheckoutSessionInitiated                    WebhookEventName = "checkout.session.initiated"
	WebhookEventNameCheckoutSessionCompleted                    WebhookEventName = "checkout.session.completed"
	WebhookEventNameCheckoutSessionFailed                       WebhookEventName = "checkout.session.failed"
	WebhookEventNameCheckoutSessionExpired                      WebhookEventName = "checkout.session.expired"
	WebhookEventNameEventRejected                               WebhookEventName = "event.rejected"
)
