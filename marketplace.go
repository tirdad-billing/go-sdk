...
func newMarketplace(rootSDK *Tirdad, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Marketplace {
	return &Marketplace{
		rootSDK:          rootSDK,
...
func (s *Marketplace) PostMarketplaceAgreements(ctx context.Context, request types.RegisterMarketplaceAgreementRequest, opts ...dtos.Option) (*dtos.PostMarketplaceAgreementsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/marketplace/agreements")
	if err != nil {
	...
	res := &dtos.PostMarketplaceAgreementsResponse{
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out types.RegisterMarketplaceAgreementResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.RegisterMarketplaceAgreementResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
