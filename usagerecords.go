...
func newUsageRecords(rootSDK *Tirdad, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *UsageRecords {
	return &UsageRecords{
		rootSDK:          rootSDK,
...
func (s *UsageRecords) PostUsageRecordsSearch(ctx context.Context, request types.UsageRecordFilter, opts ...dtos.Option) (*dtos.PostUsageRecordsSearchResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/usage-records/search")
	if err != nil {
	...
	res := &dtos.PostUsageRecordsSearchResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out types.ListUsageRecordsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListUsageRecordsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
