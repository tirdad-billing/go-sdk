...
func (s *Subscriptions) AddSubscriptionAddon(ctx context.Context, request types.AddAddonRequest, opts ...dtos.Option) (*dtos.AddSubscriptionAddonResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out types.AddAddonToSubscriptionResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AddAddonToSubscriptionResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Subscriptions) ListAllSubscriptionSchedules(ctx context.Context, pendingOnly *bool, subscriptionID *string, limit *int64, offset *int64, opts ...dtos.Option) (*dtos.ListAllSubscriptionSchedulesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/subscriptions/schedules")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Subscriptions) GetSubscriptionSchedule(ctx context.Context, scheduleID string, opts ...dtos.Option) (*dtos.GetSubscriptionScheduleResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/subscriptions/schedules/{schedule_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Subscriptions) CancelSubscriptionSchedule(ctx context.Context, scheduleID string, body *types.CancelScheduleRequest, opts ...dtos.Option) (*dtos.CancelSubscriptionScheduleResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/subscriptions/schedules/{schedule_id}/cancel", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *Subscriptions) GetSubscriptionAddonAssociations(ctx context.Context, id string, opts ...dtos.Option) (*dtos.GetSubscriptionAddonAssociationsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out types.ListAddonAssociationsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListAddonAssociationsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// ExecuteSubscriptionPlanChangeV2 - Execute a plan change (v2, swap in place)
...
func (s *Subscriptions) ExecuteSubscriptionPlanChangeV2(ctx context.Context, id string, body types.SubscriptionChangeV2Request, opts ...dtos.Option) (*dtos.ExecuteSubscriptionPlanChangeV2Response, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/subscriptions/{id}/change/v2/execute", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &dtos.ExecuteSubscriptionPlanChangeV2Response{
		HTTPMeta: types.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out types.SubscriptionChangeV2Response
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.SubscriptionChangeV2Response = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Subscriptions) PreviewSubscriptionPlanChangeV2(ctx context.Context, id string, body types.SubscriptionChangeV2Request, opts ...dtos.Option) (*dtos.PreviewSubscriptionPlanChangeV2Response, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/subscriptions/{id}/change/v2/preview", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &dtos.PreviewSubscriptionPlanChangeV2Response{
		HTTPMeta: types.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Subscriptions) ListSubscriptionSchedules(ctx context.Context, id string, opts ...dtos.Option) (*dtos.ListSubscriptionSchedulesResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/subscriptions/{id}/schedules", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
