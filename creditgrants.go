...
func newCreditGrants(rootSDK *Tirdad, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *CreditGrants {
	return &CreditGrants{
		rootSDK:          rootSDK,
...
func (s *CreditGrants) GetAddonCreditGrants(ctx context.Context, id string, opts ...dtos.Option) (*dtos.GetAddonCreditGrantsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/addons/{id}/creditgrants", request, nil)
	if err != nil {
	...
	res := &dtos.GetAddonCreditGrantsResponse{
