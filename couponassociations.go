...
type CouponAssociations struct {
	rootSDK          *Tirdad
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newCouponAssociations(rootSDK *Tirdad, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *CouponAssociations {
...
func (s *CouponAssociations) ListCouponAssociations(ctx context.Context, request dtos.ListCouponAssociationsRequest, opts ...dtos.Option) (*dtos.ListCouponAssociationsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/coupons/associations")
	if err != nil {
	...
	res := &dtos.ListCouponAssociationsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out types.ListCouponAssociationsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListCouponAssociationsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *CouponAssociations) GetCouponAssociation(ctx context.Context, id string, opts ...dtos.Option) (*dtos.GetCouponAssociationResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/coupons/associations/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &dtos.GetCouponAssociationResponse{
		HTTPMeta: types.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out types.CouponAssociationResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CouponAssociationResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
